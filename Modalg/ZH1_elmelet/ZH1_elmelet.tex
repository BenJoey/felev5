...
\begin{enumerate}
	...
	\end{itemize}
	\item\textbf{Feltételes lokális szélső érték}\br
	...
	Ha $D\subset\R^{n+1}$ tartomány és $f:D\rightarrow\R^n$ folytonos, akkor\br
	...
	\xi\in\R^n, \tau\in\R$\br
	Az $x'(t)=f(t,x(t)),\quad x(\tau)=\xi$ feladatot kezdeti érték problémának (KÉP) nevezzük.
	\item\textbf{Peano tétel}\br
	Ha $D\subset\R^{n+1}, f:D\rightarrow\R^n$ folytonos,  $(\tau, \xi)\in D$, akkor az\br
	$x'(t)=f(t,x(t)),\quad x(\tau)=\xi$ KÉP-nek $\exists$ megoldása.
	...
	L:||f(t,u)-f(t,\tilde{u})||\leq L||u-\tilde{u}||\br\forall(t,u),(t,
	...
	Tfh: $f:D\rightarrow\R^n$ folytonos függvény kielégíti a második változóban a lokális Lipschitz feltételt a
